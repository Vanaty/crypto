 ...
 */
final class Version20250204120637 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE crypto ADD symbol VARCHAR(5) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE blocked (id_token BIGINT NOT NULL, id_user BIGINT NOT NULL, expiration TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, id_blocked BIGINT NOT NULL, PRIMARY KEY(id_token))');
        ...
        $this->addSql('ALTER TABLE crypto DROP symbol');
    }
}
